...
from api.serializers import (
    ...
    VacancySerializer, SummarySerializer,
    MessageSerializer, VacancyPublicationSerializer, 
    SummaryPublicationSerializer
)
...
class MessageCreateView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        response = get_object_or_404(ResponseModel, pk=self.kwargs.get('pk'))
